...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	bool result;
	WCHAR vs[] = L"../DirectX-Graphic-Framework/Color.vs";
	WCHAR ps[] = L"../DirectX-Graphic-Framework/Color.ps";
	//WCHAR vs[] = L"Color.vs";
	//WCHAR ps[] = L"Color.ps";
...
{
	// Set the shader parameters that it will use the rendering.
...
bool ColorShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	HRESULT result = D3DCompileFromFile(vsFilename, NULL, NULL, "ColorVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS,
